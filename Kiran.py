...
def main():
	...
	print(" \033[1;39m [5]COMMENT VOTING")
        print(" \033[1;39m [6]COMMENT RC SPEED VOTING")
	print(" \033[1;39m [7]CREATE PAGES")
	print(" \033[1;39m [8]FACEBOOK FOLLOWERS")
	print(" \033[1;39m [9]JOIN GROUPS")
	print(" \033[1;39m [10]PROFILE CHANGE ")
	print(" \033[1;39m [11]COVER CHANGE")
	linex()
