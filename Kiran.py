...
\033[1;94m  •  𝙊𝙒𝙉𝙀𝙍     MARINA x KIRAN   •     
\033[1;94m  •   𝙂𝘼𝙉𝙂     T.R.C IS BACK     •                   
\033[1;94m•••••••••••••••••••••••••••••••••••"""
...
def main():
	clear()
	print("")
	print("\033[1;96m     YOUR TOKEN IS NOT APPROVED ALLREADY")
	print("")
	print(" \033[1;96m \033[1;32m [1] COPY TOKEN AND SEND ADMINS FOR APPROVAL")
	print(" \033[1;96m \033[1;31m YOUR TOKEN IS:TF633747JAN4954JF5375")
	
	baloch = input("\n\033[1;96m PRESS ENTER OR COPY TOKEN::")
	if baloch in ["", " "]:
		exit()
	elif baloch in ["2", "02"]:
			...
			os.system("clear")
	print(logo)
	print(" \033[1;94m [1]FACEBOOK POLL VOTING WITH CODE")
	print(" \033[1;94m [2]POSTS, VIDEOS, STORIES, LIKE VOTING")
	print(" \033[1;94m [3]FACEBOOK REELS LIKE VOTING")
	print(" \033[1;94m [4]COMMENT LIKE VOTING")
	print(" \033[1;94m [5]COMMENT VOTING")
	print(" \033[1;94m [6]CREATE PAGES")
	print(" \033[1;94m [7]FACEBOOK FOLLOWERS")
	print(" \033[1;94m [8]JOIN GROUPS")
	print(" \033[1;94m [9]PROFILE CHANGE ")
	print(" \033[1;94m [10]COVER CHANGE")
	linex()
